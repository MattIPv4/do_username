...
pub mod do_username {
	...
	lazy_static! {
		...
		pub static ref SEA_OBJECTS: std::vec::Vec<&'static str> = vec!["boatShip", "submarine", "yacht", "dinghy", "raft", "kelp", "seaweed", "anchor"];
		...
		pub static ref SIZE_DESCRIPTORS: std::vec::Vec<&'static str> = vec!["large", "big", "small", "giant", "massive", "tiny", "little", "yuge"];
